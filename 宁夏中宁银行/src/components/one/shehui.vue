<template>
  <div class="shehui_content">
    <div class="navs_h"></div>
    <div class="title">{{datas.data_name}}</div>
    <img class="shehui_bg" src="../../../static/img/product_bg.jpg" alt="">
    <div class="content">
      <div class="content_title">
        <span @click="tohome()">首页</span> > <span>社会责任</span> >
      </div>
...
//        console.log(this.article);
      ...
      getData(){
        this.$http.get('http://www.nxqybank.com/pc/index.php/Index/shehui').then(response => {

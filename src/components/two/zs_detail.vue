  ...
  <div class="detail_content">
    ...
    <div class="content">
      <div class="content_title">
        <span @click="tohome()">首页</span> > <span @click="toprve()">产品展示</span> > <span>详情</span>
      </div>
...
<script>
  export default {
    ...
    created:function () {
      this.$http.get('http://www.nxqybank.com/pc/index.php/Index/article_c/id/'+this.id).then(response => {

<template>
  <div class="xiuxian_content">
    ...
    <img class="xiuxian_bg" src="../../../static/img/product_bg.jpg" alt="">
    <div class="content">
      <div class="content_title">
        <span @click="tohome()">首页</span> > <span>休闲专区</span> >
      </div>
...
//        console.log(this.article);
      ...
      getData(){
        this.$http.get('http://www.nxqybank.com/pc/index.php/Index/xiuxian').then(response => {

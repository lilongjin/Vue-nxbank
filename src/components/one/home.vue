  ...
  <div class="home_content">
      ...
      <div class="bank_login_contents">
        <div class="bank_login_content">
          <div class="bank_login_list">
            ...
            <a :href="home_data.denglu1.url" target="_blank">{{home_data.denglu1.title}}</a>
          </div>
          <div class="bank_login_list">
            <span class="glyphicon glyphicon-equalizer"></span>&nbsp;&nbsp;
            <a :href="home_data.denglu2.url" target="_blank">{{home_data.denglu2.title}}</a>
          </div>
          <div class="bank_login_list">
            <span class="glyphicon glyphicon-download"></span>&nbsp;&nbsp;
            <a :href="home_data.denglu3.url" target="_blank">{{home_data.denglu3.title}}</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="product_show">
      <div class="product_title">
        <img v-bind:src="home_data.chanpin_img" alt="">
        产品展示
      </div>
    ...
    <!--文化建设-->
    <div class="culture">
      <img class="culture_bg" v-bind:src="home_data.jianshe_img1" alt="">
    ...
    <div class="media">
      ...
      <div class="media_content">
        <div class="media_list" v-for="item in home_data.hezuo.article">
          <img v-bind:src="item.img" @click="toDetail(item.id)">
          <div class="title" @click="toDetail(item.id)">{{item.title}}</div>
          <div class="content" @click="toDetail(item.id)">{{item.describe}}</div>
          <div class="more" @click="tolist()">更多 >></div>
        </div>
      </div>
    </div>
    <!--服务与休闲-->
    <div class="serve">
      <img class="serve_bg" v-bind:src="home_data.fuwu_img" alt="">
    ...
    <div class="about_content">
      ...
      <div class="about_bg">
        <img v-bind:src="home_data.guanyu_img" alt="">
      </div>
      <div class="content_list">
...
//        console.log('before')
      ...
      getData(){
        this.$http.get('http://www.nxqybank.com/pc/index.php/Index/index').then(response => {
